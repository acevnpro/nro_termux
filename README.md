...
```bash
wget https://github.com/qwertyly2-lang/nro_termux/releases/download/v1.2/nro.py
```
*Nếu lệnh `wget` ở trên bị lỗi, hãy dùng lệnh `curl` thay thế dưới đây:*
```bash
curl -LO https://github.com/qwertyly2-lang/nro_termux/releases/download/v1.2/nro.py
```
...
```bash
curl -LO https://github.com/qwertyly2-lang/nro_termux/releases/download/v1.2/nro3.py
```
...
```bash
curl -LO https://github.com/qwertyly2-lang/nro_termux/releases/download/v1.2/nro4.py
```
